        ...
        <div class="col-xl-3 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Pendapataan</h5>
              ...
              <p class="mt-3 mb-0 text-sm">
                ...
                <span class="text-nowrap">
                  <a href="<?php echo site_url('admin/laporan'); ?>" class="text-nowrap">Total Pendapatan</a>
                </span>
              </p>
            </div>
          </div>
...
<div class="container-fluid mt--6">
  <div class="row">
    ...
    <!-- end diagram cart grafik -->

    <!-- Diagram Batang Cart Samping Kanan -->
    <div class="col-xl-4">
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-uppercase text-muted ls-1 mb-1">Ringkasan bulanan</h6>
    ...
    <!-- End Diagram Batang Cart Samping Kanan -->
  </div>
  <div class="row">
    <div class="col-xl-4">
