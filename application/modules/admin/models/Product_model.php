...
class Product_model extends CI_Model {
    ...
    {
        $products = $this->db->like('name', $query)->or_like('descript', $query)->get('products', $limit, $start)->result();
    ...
    {
        $count = $this->db->like('name', $query)->or_like('descript', $query)->get('products')->num_rows();
