      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo get_user_image(); ?>" class="user-image img-circle elevation-2"
              alt="User Image">
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header bg-primary">
              <img src="<?php echo get_user_image(); ?>" class="img-circle elevation-2" alt="User Image">
              <p>
                <?= get_user_name(); ?>
                <small></small>
              </p>
            ...
            <li class="user-footer">
              <a href="<?php echo site_url('customer/profile'); ?>" class="btn btn-default btn-flat">Profil</a>
              <a href="<?php echo site_url('auth/logout'); ?>" class="btn btn-default btn-flat float-right">Log Out</a>
            </li>
          </ul>
        </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="<?php echo get_user_image(); ?>" class="d-block"><?php echo get_user_name(); ?></a>
          </div>
        </div>
