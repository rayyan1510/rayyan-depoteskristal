    ...
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2"><a href="#">Depot Es Kristal</a></h2>
          <p><a href="#">Semua Es Kristal Disini Higienis</a></p>
          <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5">
            <center>
              <li class="ftco-animate"><a href="https://wa.me/6281211780478/?text=saya+ingin+membeli+es+kristal." target='_BLANK'><span
        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="d-flex">
            <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
              ...
              <li><a href="#" class="py-2 d-block">Testimoni Pelanggan</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          ...
          <a href="http://colorlib.com" target="_blank" rel="noopener noreferrer">Colorlib.</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          Modified by Depot Es Kristal Jalan Bilal
        </p>
      </div>
    </div>
  </div>
