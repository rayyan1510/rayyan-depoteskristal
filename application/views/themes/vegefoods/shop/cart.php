...
?>
<!-- banner -->
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/es batu.jfif'); ?>');">
  <div class="container">
                    ...
                    <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                      ...
                      <td class="quantity">
                        <div class="input-group mb-3">
                          <input type="text" name="quantity[<?php echo $item['rowid']; ?>]" class="quantity form-control input-number" value="<?php echo $item['qty']; ?>" min="1" max="100" readonly>
                        </div>
                      </td>
